  ...
  return (
    <div className="flex flex-col gap-8 bg-[#f5f5f5]">
      ...
      <OurMission
        ...
        button={
          <button className="px-6 py-3 text-[#032432] text-base border border-[#101010] font-semibold rounded-full hover:bg-gray-100">
            Button example
          </button>
        }
      />
      ...
      <BookACallCTA
        ...
        imageUrl="/path/to/consultant-image.jpg"
      />
    </div>
  );
}
