    ...
    <section className="flex flex-col lg:flex-row justify-between items-center gap-8">
      <div className="bg-[#E5DFD9] flex flex-col gap-8 md:gap-10 p-8 rounded-[20px]">
        ...
        <p className="text-sm font-normal font-secondary text-main">
          Sam is our Principal Coach and Lead Trainer at ValueHut Consulting; He
          is an agnostic Enterprise Agile Coach and Practitioner, a Professional
          Scrum Trainer with Scrum.org. In the last 20years, Sam has supported
          individuals, teams and Organisations to deliver value using Agile
          Frameworks and Practices; ultimately developing the mindset required
          to thrive in Volatile, Uncertain, Complex and Ambiguous (VUCA)
      ...
      <div className="bg-[#A5E0E7] flex flex-col gap-8 md:gap-10 p-8 rounded-[20px]">
        ...
        <p className="text-sm font-normal font-secondary text-main">
          ...
          is an experienced Lean-Agile Practitioner, Accredited Kanban Trainer,
          ICAgile Instructor Agile Coach, Professional Scrum Master, Agile
          Project Manager, SAFe Program consultant and Kanban Management
