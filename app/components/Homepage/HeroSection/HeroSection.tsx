    ...
    >
      <div className="container w-full flex relative px-8 md:px-0 mb-10">
        <div className="absolute flex flex-col gap-4 space-y-3 bottom-10 w-full md:w-1/2 text-accentmain">
          <h1 className="text-7xl sm:text-[87px] md:max-w-2xl font-primary sm:leading-[95.7px] font-semibold">
            {title}
          </h1>
          <p className="text-base sm:text-xl md:max-w-3xl font-semibold">
            {subtitle}
          </p>
          {buttonText && (
            <a href={buttonLink}>
