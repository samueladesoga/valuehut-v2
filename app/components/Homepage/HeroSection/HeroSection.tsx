...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    ...
    >
      <div className=" mx-6 sm:mx-16 w-full flex relative px-6 sm:px-0 mb-10 ">
        <div className="absolute flex flex-col gap-4 space-y-3  bottom-10 w-full  md:w-1/2 text-accentmain">
          <h1 className="text-[47px] sm:text-[87px] max-w-[70%] leading-[51px] sm:leading-[95.7px] font-semibold ">
            {title}
          </h1>
          <p className="text-[18px] sm:text-[21px] leading-[27px] sm:leading-[31px] max-w-[70%]  font-semibold">{subtitle}</p>
          <a href={buttonLink}>
