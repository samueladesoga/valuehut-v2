...
const Navbar = ({ logo, navLinks = [] }: NavbarProps) => {
  return (
    <div className="fixed w-full mt-3 z-50 ">
      <nav className="container bg-[#707070]/10 backdrop-blur-3xl rounded-xl mx-auto text-white py-4 shadow-md">
        <div className="relative z-10 flex items-center justify-between px-6 max-w-screen-xl mx-auto">
